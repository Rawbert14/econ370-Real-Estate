...
# read in the housing data as a pandas dataframe
...
# Open the counties zip file
with zipfile.ZipFile('simplemaps_uscities_basicv1.76.zip', 'r') as zip_file:
...
macro_factors = ['Per Capita Personal Income', 'Unemployment Rate', 'Total Gross Domestic Product', 'Resident Population', 'Consumer Price Index', 'Combined Violent and Property Crime', 'T01 Property Taxes']
            ...
            if response.status_code == 200:
                ...
                for i in pd.Series(range(min(json_data['count'], 1000))):
                    ...
                    if factor == 'Per Capita Personal Income' or factor == 'Unemployment Rate' or factor == 'Total Gross Domestic Product' or factor == 'Resident Population':
                        ...
                        substrings = [f'{factor}', f'{city}', f'{state}', 'SA)']
